          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              {onGoHome ? (
                <button
                  type="button"
                  onClick={onGoHome}
                  className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-spotify-green focus:ring-offset-2 focus:ring-offset-spotify-black rounded-lg"
                  aria-label="Back to playlists"
                >
                  <div className="w-9 h-9 bg-spotify-green rounded-lg flex items-center justify-center">
                  ...
                  <h1 className="text-xl font-bold text-white tracking-tight">
                    Spot<span className="text-spotify-green">Download</span>
                  </h1>
                </button>
              ) : (
                <>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-spotify-green pulse-green"></div>
                <span className="text-xs text-spotify-light-gray">Connected</span>
              </div>
              <button
